...
The chatbot uses a combination of helpful tools working together:
Script Search (RAG)
...
* Ask questions about episodes or characters
* Explore themes like leadership, ethics, and diplomacy
* Recall dialogue grounded in the scripts
* Get summaries supported by real scenes
* Ask questions that combine story details with facts or numbers
